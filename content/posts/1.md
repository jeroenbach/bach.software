...
There are cases where you would like to re-use your component for multi and single values, but you don't want to introduce another property or emit (like I've done with the BlogPostContext.vue within this [website project](https://github.com/jeroenbach/bach.software)).
...
This is great! When using this in a component we would also like to leave out the parameter (attribute) completely.
...
### Bonus: Advanced Select & MultiSelect

The UI library PrimeVue has both a Select and MultiSelect component and allows you to use more then just a string value. They resolve this by making their modelValue of type any.
...
<script
  ...
  "
>
import VSelect, { type VSelectProps } from "primevue/multiselect";
...
interface Props
  extends Omit<VSelectProps, "modelValue" | "options" | "optionValue"> {
  modelValue?: TSingleOrMultiple;
