<template>
  <NuxtLayout name="2column">
    ...
    <template #side> Some header template content. </template>
  </NuxtLayout>
</template>
...
const posts = [
  {
    ...
    href: "/posts/1-boost-your-conversion-rate",
    description:
  ...
  },
  {
    id: 2,
    title: "Boost your conversion rate",
    href: "/posts/1-boost-your-conversion-rate-123",
    description:
      "Illo sint voluptas. Error voluptates culpa eligendi. Hic vel totam vitae illo. Non aliquid explicabo necessitatibus unde. Sed exercitationem placeat consectetur nulla deserunt vel. Iusto corrupti dicta.",
    date: "Mar 16, 2020",
    datetime: "2020-03-16",
