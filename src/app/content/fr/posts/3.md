...
::post-image{src="posts/3/plausibe-goals.png" alt="Nos étapes de progression de lecture définies comme objectifs dans Plausible" caption="Ici vous voyez combien de personnes ont ouvert, jeté un coup d'œil ou lu mon premier article" cssClass="aspect-[735/468]"}
::
...
::post-image{src="posts/3/plausibe-goals.png" alt="Nos étapes de progression de lecture définies comme objectifs dans Plausible" caption="Nos étapes de progression de lecture définies comme objectifs dans Plausible" cssClass="aspect-[735/468]"}
::
