...
::post-image{src="posts/1/code-example.gif" alt="Exemple de code"}
::
...
## Exemple pratique utilisant PrimeVue

La bibliothèque d'interface PrimeVue fournit à la fois un composant Select et MultiSelect. Utilisons ce que nous avons appris jusqu'à présent pour les combiner en un seul. De plus, ces composants permettent de spécifier n'importe quel type de tableau d'objets comme options.
...
::post-image{src="posts/1/code-example-2.gif" alt="Exemple de code"}
::
...
// Utiliser le type MultiSelectProps de PrimeVue, mais avec un meilleur typage
interface Props
...
- Importer les composants PrimeVue: Nous avons importé les deux composants PrimeVue et les avons affichés en fonction de la propriété multiple.
