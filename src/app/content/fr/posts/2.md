...
::post-image{src="posts/2/plausible-costs.jpg" alt="Coûts Azure Kubernetes pour Plausible.io" caption="Coûts Azure Kubernetes pour Plausible.io"}
::
...
::post-image{src="posts/2/plausible-installed.jpg" alt="Écran de configuration de la communauté Plausible.io" caption="Écran de configuration de la communauté Plausible.io"}
::
