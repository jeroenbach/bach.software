...
>(
  ...
  // - Je krijgt hier een TypeScript fout - Type 'K' is not assignable to type 'TKeyType' [!code highlight]
...
In dit scenario, ongeacht de parameters die aan `toMap` worden doorgegeven, zal de resulterende map altijd de key en value types `T` hebben.
