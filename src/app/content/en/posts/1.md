...
::post-image{src="posts/1/code-example.gif" alt="Code example" cssClass="aspect-[735/520]"}
::
...
## Practical Example using ElementPlus

The UI library ElementPlus provides a Select component with a `multiple` prop. Let's use what we've learned so far to make this component type safe. Additionally, this component allows specifying any type of object array as the options.
...
::post-image{src="posts/1/code-example-2.gif" alt="Code example" cssClass="aspect-[735/520]"}
::
...
- Import ElementPlus Components: We imported both ElementPlus components and displayed them based on the multiple property.
