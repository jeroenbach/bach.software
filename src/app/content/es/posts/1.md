...
::post-image{src="posts/1/code-example.gif" alt="Ejemplo de código"}
::
...
## Ejemplo práctico usando PrimeVue

La biblioteca de UI PrimeVue proporciona tanto un componente Select como MultiSelect. Usemos lo que hemos aprendido hasta ahora para combinarlos en uno. Además, estos componentes permiten especificar cualquier tipo de array de objetos como opciones.
...
::post-image{src="posts/1/code-example-2.gif" alt="Ejemplo de código"}
::
...
// Usar el tipo MultiSelectProps de PrimeVue, pero con mejor tipado
interface Props
...
- Importar componentes PrimeVue: Importamos ambos componentes PrimeVue y los mostramos según la propiedad multiple.
